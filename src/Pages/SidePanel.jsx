	...
	const handleLogout = async () => {
		try {
			...
			if (onLogout) {
				...
				// Default logout behavior if no function is provided
				console.log('Logging out...');
				// In a real app, you might redirect to login page after a timeout
				setTimeout(() => {
...
SidePanel.propTypes = {
	/**
	 * Callback function invoked when navigation item is clicked
	 */
